...
const VarietyDetail: React.FC<VarietyDetailProps> = ({ variety }) => {
  return (
    <div className="md:max-w-[624px] md:max-h-[328px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2 bg-gray-100 p-4 rounded-xl">
        ...
        <div className="col-span-1 ">
          ...
          <p className="mb-1 text-sm md:text-base">
            ...
            {StaticData.getFruitSize().get(variety.fruit_size)}
          </p>
          <p className="mb-1 text-sm md:text-base">
            <span className="font-medium md:font-bold">Hình dạng: </span>
            {StaticData.getFruitShape().get(variety.fruit_shape)}
          </p>
        </div>
        <div className="col-span-1 ">
          <p className="mb-1 text-sm md:text-base">
